...
import { idlFactory } from './internet-identity.did.js';
export { idlFactory } from './internet-identity.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_INTERNET-IDENTITY;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./internet-identity.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the internet-identity canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./internet-identity.did.js")._SERVICE>}
 */
